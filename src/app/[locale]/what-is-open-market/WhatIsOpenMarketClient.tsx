...
export default function WhatIsOpenMarketClient() {
    const t = useTranslations('whatIsOpenMarket');
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-4 pt-16 pb-12 sm:pt-20 sm:pb-16 text-center">
                    ...
                    <div className="transition-all duration-1000 transform opacity-100 translate-y-0">
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-slate-900 mb-6 tracking-tight leading-[1.1]">
                            {t('hero.title')} <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-sky-400 to-blue-600 animate-gradient bg-[length:200%_auto]">{t('hero.titleGradient')}</span>
                        </h1>
                    </div>
                    <div className="transition-all duration-1000 transform opacity-100 translate-y-0">
                        <p className="text-lg sm:text-xl text-slate-500 mb-10 max-w-2xl mx-auto leading-relaxed font-light">
                            ...
                            <span className="font-medium text-slate-900">{t('hero.subtitleHighlight')}</span>
                        </p>
                    </div>
                    <div className="transition-all duration-1000 transform opacity-100 translate-y-0">
                            ...
                            <div className="relative pl-8 border-l-4 border-gray-100">
                                <div className="mb-8">
                                    ...
                                    <h2 className="text-3xl font-bold text-slate-900 mb-4 leading-tight">
                                        {t('theWhy.title')} <span className="text-red-500 bg-red-50 px-2 rounded-md">{t('theWhy.titleHighlight')}</span>
                                    </h2>
                                    <p className="text-slate-500 text-lg leading-relaxed">
                                        {t('theWhy.description')}
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="bg-gradient-to-br from-slate-50 to-white rounded-[2.5rem] p-8 sm:p-12 border border-slate-100 shadow-2xl shadow-slate-200/50 relative overflow-hidden group hover:border-blue-100 transition-colors duration-500">
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center gap-3 mb-8">
                                        ...
                                        <h3 className="font-bold text-2xl text-slate-900">{t('theWhy.solution')}</h3>
                                    </div>
                                    <p className="text-slate-600 mb-10 leading-relaxed font-medium">
                                        {t('theWhy.solutionDesc')}
                                    </p>
                                    <ul className="space-y-6">
                                        <li className="flex gap-4 items-start">
                                            ...
                                            <div>
                                                <strong className="text-slate-900 text-base block mb-1">{t('theWhy.features.ownData')}</strong>
                                                <p className="text-sm text-slate-500 leading-relaxed">{t('theWhy.features.ownDataDesc')}</p>
                                            </div>
                                        </li>
                                        <li className="flex gap-4 items-start">
                                            <div className="min-w-[24px] pt-1">
                                            ...
                                            <div>
                                                <strong className="text-slate-900 text-base block mb-1">{t('theWhy.features.ownAudience')}</strong>
                                                <p className="text-sm text-slate-500 leading-relaxed">{t('theWhy.features.ownAudienceDesc')}</p>
                                            </div>
                                        </li>
                                        <li className="flex gap-4 items-start">
                                            <div className="min-w-[24px] pt-1">
                                            ...
                                            <div>
                                                <strong className="text-slate-900 text-base block mb-1">{t('theWhy.features.portable')}</strong>
                                                <p className="text-sm text-slate-500 leading-relaxed">{t('theWhy.features.portableDesc')}</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="transition-all duration-1000 transform opacity-100 translate-y-0">
                        <div className="text-center max-w-2xl mx-auto mb-16">
                            <span className="text-blue-600 font-bold text-xs uppercase tracking-wider bg-blue-50 px-3 py-1 rounded-full">{t('forSellers.badge')}</span>
                            <h2 className="text-3xl font-bold text-slate-900 mt-4 mb-4">{t('forSellers.title')}</h2>
                            <p className="text-slate-500 text-base">
                                {t('forSellers.subtitle')}<span className="font-bold text-slate-900 bg-yellow-100 px-1">{t('forSellers.subtitleHighlight')}</span>.
                            </p>
                        </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="transition-all duration-1000 transform opacity-100 translate-y-0">
                            <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-blue-900/5 hover:-translate-y-2 transition-all duration-300 h-full">
                                ...
                                <h3 className="font-bold text-xl text-slate-900 mb-3">{t('forSellers.storefront.title')}</h3>
                                <p className="text-slate-500 text-sm leading-relaxed">{t('forSellers.storefront.desc')}</p>
                            </div>
                        </div>
                        <div className="transition-all duration-1000 transform opacity-100 translate-y-0">
                            <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-blue-900/5 hover:-translate-y-2 transition-all duration-300 h-full">
                                ...
                                <h3 className="font-bold text-xl text-slate-900 mb-3">{t('forSellers.traffic.title')}</h3>
                                <p className="text-slate-500 text-sm leading-relaxed">{t('forSellers.traffic.desc')}</p>
                            </div>
                        </div>
                        <div className="transition-all duration-1000 transform opacity-100 translate-y-0">
                            <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-blue-900/5 hover:-translate-y-2 transition-all duration-300 h-full">
                                ...
                                <h3 className="font-bold text-xl text-slate-900 mb-3">{t('forSellers.zeroFees.title')}</h3>
                                <p className="text-slate-500 text-sm leading-relaxed">{t('forSellers.zeroFees.desc')}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="bg-slate-900 text-white py-24 rounded-3xl mx-4 md:mx-6 overflow-hidden relative">
                ...
                <div className="max-w-5xl mx-auto px-6 relative z-10">
                    <div className="text-center mb-16">
                        <span className="text-blue-400 font-bold uppercase tracking-wider text-sm">{t('forCommunity.badge')}</span>
                        <h2 className="text-4xl font-bold mt-2 text-white">{t('forCommunity.title')}</h2>
                        <p className="text-xl text-slate-300 mt-4 max-w-2xl mx-auto">
                            {t('forCommunity.subtitle')}
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-12">
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-bold mb-2 text-white">{t('forCommunity.local.title')}</h3>
                            <p className="text-slate-400">{t('forCommunity.local.desc')}</p>
                        </div>
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-bold mb-2 text-white">{t('forCommunity.chat.title')}</h3>
                            <p className="text-slate-400">{t('forCommunity.chat.desc')}</p>
                        </div>
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-bold mb-2 text-white">{t('forCommunity.trust.title')}</h3>
                            <p className="text-slate-400">{t('forCommunity.trust.desc')}</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div className="py-24 bg-white border-y border-slate-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-blue-600 font-bold tracking-wide uppercase text-xs mb-3">{t('howItWorks.badge')}</h2>
                        <h3 className="text-3xl sm:text-4xl font-black text-slate-900 mb-6">{t('howItWorks.title')}</h3>
                        <p className="text-lg text-slate-500 leading-relaxed">
                            {t.rich('howItWorks.subtitle', {
                                atproto: (children) => <span className="text-slate-900 font-semibold">{children}</span>,
                            })}
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                        ...
                        <div className="relative group">
                            ...
                            <div className="text-center px-2">
                                <h4 className="text-xl font-bold text-slate-900 mb-3">{t('howItWorks.step1.title')}</h4>
                                <p className="text-slate-500 leading-relaxed text-sm">{t('howItWorks.step1.desc')}</p>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="text-center px-2">
                                <h4 className="text-xl font-bold text-slate-900 mb-3">{t('howItWorks.step2.title')}</h4>
                                <p className="text-slate-500 leading-relaxed text-sm">{t('howItWorks.step2.desc')}</p>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="text-center px-2">
                                <h4 className="text-xl font-bold text-slate-900 mb-3">{t('howItWorks.step3.title')}</h4>
                                <div className="text-left bg-gray-50/50 rounded-xl p-4 mt-2 text-sm space-y-3 border border-gray-100">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <p className="text-slate-600 text-xs leading-5">
                                            <span className="font-bold text-slate-900 block">{t('howItWorks.step3.online.title')}</span>
                                            {t('howItWorks.step3.online.desc')}
                                        </p>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        <div className="min-w-[20px] pt-0.5">
                                        ...
                                        <p className="text-slate-600 text-xs leading-5">
                                            <span className="font-bold text-slate-900 block">{t('howItWorks.step3.community.title')}</span>
                                            {t('howItWorks.step3.community.desc')}
                                        </p>
                                    </div>
                                </div>
                            </div>
