      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="flex gap-2 mb-4">
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${listingTypeFilter === 'all'
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm font-medium transition-colors flex items-center gap-1.5 ${listingTypeFilter === 'online'
              ? 'bg-slate-900 text-white'
              : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm font-medium transition-colors flex items-center gap-1.5 ${listingTypeFilter === 'community'
              ? 'bg-slate-900 text-white'
              : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
              }`}
          >
