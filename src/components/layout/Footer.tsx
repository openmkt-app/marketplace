        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="mt-4 flex space-x-4">
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-primary-color transition-colors">
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-primary-color transition-colors">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-text-primary">About AT Protocol</h3>
            <p className="text-text-primary text-sm mb-4">
              The Authenticated Transfer Protocol is a decentralized social networking
              technology developed by Bluesky, designed for portable identity and content.
            </p>
            <a 
