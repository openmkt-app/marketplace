  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 flex items-center">
              <span className="bg-gradient-to-r from-indigo-500 to-blue-500 bg-clip-text text-transparent text-xl font-bold">
                AT Marketplace
              </span>
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/create-listing" className="text-gray-300 hover:text-white transition-colors">
                  Create Listing
                </Link>
              </li>
              <li>
        ...
        <div className="py-4 border-t border-gray-800 text-sm text-gray-400 text-center">
